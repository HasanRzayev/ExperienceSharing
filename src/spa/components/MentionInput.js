  ...
  return (
    <div className="relative">
      <textarea
        ...
        className={`w-full resize-none rounded-lg border border-gray-300 p-3 focus:border-purple-500 focus:outline-none ${className}`}
        rows={3}
      />
      ...
      {showSuggestions && suggestions.length > 0 && (
        <div 
          ref={suggestionRef}
          className="absolute z-50 mt-1 max-h-48 w-full overflow-y-auto rounded-lg border border-gray-300 bg-white shadow-lg"
          style={{ top: '100%' }}
        >
