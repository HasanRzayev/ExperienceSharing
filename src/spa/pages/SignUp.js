          ...
          <div className="grid gap-0 md:grid-cols-2">
            ...
            <div className="relative flex flex-col items-center justify-center bg-gradient-to-br from-orange-600 via-red-600 to-amber-700 p-12 text-white">
              ...
              <div className="relative z-10 text-center">
                ...
                <h1 className="mb-6 text-5xl font-bold">Join Our Community!</h1>
              ...
              <div className="mx-auto w-full max-w-md">
                ...
                <form className="space-y-6" onSubmit={handleSignUp}>
                  ...
                  <div>
                    ...
                    <div className="mt-1 flex justify-center rounded-lg border-2 border-dashed border-gray-300 px-6 pb-6 pt-5 transition-colors hover:border-orange-400">
                      <div className="space-y-1 text-center">
                        <svg className="mx-auto size-12 text-gray-400" stroke="currentColor" fill="none" viewBox="0 0 48 48">
                          <path d="M28 8H12a4 4 0 00-4 4v20m32-12v8m0 0v8a4 4 0 01-4 4H12a4 4 0 01-4-4v-4m32-4l-3.172-3.172a4 4 0 00-5.656 0L28 28M8 32l9.172-9.172a4 4 0 015.656 0L28 28m0 0l4 4m4-24h8m-4-4v8m-12 4h.02" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                        <div className="flex text-sm text-gray-600">
                          <label htmlFor="file-upload" className="relative cursor-pointer rounded-md bg-white font-medium text-orange-600 focus-within:outline-none hover:text-orange-500">
                ...
                <div className="mt-8 text-center">
                  <p className="text-gray-600">
                    ...
                    <a href="/login" className="ml-1 font-semibold text-green-600 hover:text-green-500">
                      Sign In
                    </a>
                  </p>
                </div>
