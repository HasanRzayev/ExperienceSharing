...
const ProfilePage = () => {
  ...
  if (!userData) {
    return <div className="py-10 text-center text-gray-600">Yükleniyor...</div>;
  }
          ...
          <div className="relative h-64 bg-gradient-to-r from-purple-600 via-blue-600 to-indigo-600">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center text-white">
                <h1 className="mb-2 text-4xl font-bold">Welcome to Your Profile</h1>
                <p className="text-xl opacity-90">Share your amazing experiences with the world</p>
              </div>
            </div>
            
            {/* Decorative Elements */}
            <div className="absolute right-6 top-6 size-16 rounded-full bg-white opacity-10"></div>
            <div className="absolute bottom-6 left-6 size-12 rounded-full bg-white opacity-10"></div>
          </div>

          {/* Profile Info */}
          <div className="relative -mt-20 p-8">
            <div className="flex flex-col items-center space-y-6 md:flex-row md:items-end md:space-x-8 md:space-y-0">
              <div className="relative">
                <img
                  className="size-40 rounded-full border-8 border-white object-cover shadow-2xl"
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <div className="flex flex-col items-center justify-center space-y-2 text-gray-600 sm:flex-row sm:space-x-6 sm:space-y-0 md:justify-start">
            ...
            {/* Stats */}
            <div className="mt-8 flex justify-center space-x-12 border-t pt-8 md:justify-start">
              <div onClick={() => navigate("/Follow")} className="group cursor-pointer text-center">
                <div className="text-3xl font-bold text-gray-800 transition-colors group-hover:text-purple-600">
                  {followersCount}
                </div>
                <div className="font-medium text-gray-600">Followers</div>
              </div>
              <div onClick={() => navigate("/Following")} className="group cursor-pointer text-center">
                <div className="text-3xl font-bold text-gray-800 transition-colors group-hover:text-purple-600">
                  {followingCount}
                </div>
                <div className="font-medium text-gray-600">Following</div>
              </div>
              <div className="group cursor-pointer text-center">
                <div className="text-3xl font-bold text-gray-800 transition-colors group-hover:text-purple-600">
                  {userExperiences.length}
                </div>
                <div className="font-medium text-gray-600">Experiences</div>
              </div>
              <div 
        ...
        <div className="mb-8">
            ...
            <>
              {userExperiences.length > 0 ? (
                ...
                <div className="py-20 text-center">
                  <div className="glass mx-auto max-w-md rounded-3xl p-12">
                    <div className="mb-4 text-6xl">📝</div>
                    <h3 className="mb-2 text-2xl font-bold text-gray-800">No experiences yet</h3>
          ...
          {activeTab === 'liked-experiences' && (
            <>
              {loadingLiked ? (
                <div className="py-20 text-center">
                  <div className="inline-block size-12 animate-spin rounded-full border-b-2 border-purple-600"></div>
                ...
                <div className="py-20 text-center">
                  <div className="glass mx-auto max-w-md rounded-3xl p-12">
                    <div className="mb-4 text-6xl">💖</div>
                    <h3 className="mb-2 text-2xl font-bold text-gray-800">No liked experiences yet</h3>
                    <p className="mb-6 text-gray-600">
