...
function Login({ onLogin }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-orange-900 via-red-900 to-amber-900 p-4">
      <div className="w-full max-w-6xl">
        <div className="glass overflow-hidden rounded-3xl shadow-2xl">
          <div className="grid gap-0 md:grid-cols-2">
            {/* Left Side - Visual */}
            <div className="relative flex flex-col items-center justify-center bg-gradient-to-br from-orange-600 via-red-600 to-amber-700 p-12 text-white">
              ...
              {/* Decorative Elements */}
              <div className="absolute right-10 top-10 size-20 rounded-full bg-white opacity-10"></div>
              <div className="absolute bottom-10 left-10 size-16 rounded-full bg-white opacity-10"></div>
              <div className="absolute left-5 top-1/2 size-12 rounded-full bg-white opacity-10"></div>
            </div>

            {/* Right Side - Form */}
            <div className="flex flex-col justify-center bg-white p-12 dark:bg-gray-800">
              <div className="mx-auto w-full max-w-md">
                <div className="mb-8 text-center">
                  <h2 className="mb-2 text-3xl font-bold text-gray-800 dark:text-gray-100">Sign In</h2>
                ...
                <div className="mt-8 text-center">
                  <p className="text-gray-600">
                    ...
                    <a href="/signup" className="ml-1 font-semibold text-orange-600 hover:text-orange-500">
                      Create Account
                    </a>
                  </p>
                </div>
                ...
                <div className="mt-6 text-center">
                  ...
                  <div className="mt-4">
                    <button 
                      ...
                      className="transition-smooth inline-flex w-full items-center justify-center rounded-md border border-orange-300 bg-orange-50 px-4 py-3 text-sm font-medium text-orange-700 shadow-sm hover:bg-orange-100"
                    >
                ...
                <div className="mt-8">
                  ...
                  <div className="mt-6">
                    <button className="transition-smooth inline-flex w-full justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-500 shadow-sm hover:bg-gray-50">
