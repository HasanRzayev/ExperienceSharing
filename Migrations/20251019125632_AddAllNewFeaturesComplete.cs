...
{
    public partial class AddAllNewFeaturesComplete : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExperienceCollaborators", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExperienceCollaborators_Experiences_ExperienceId",
                        column: x => x.ExperienceId,
                        principalTable: "Experiences",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExperienceCollaborators_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TripExperiences", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TripExperiences_Experiences_ExperienceId",
                        column: x => x.ExperienceId,
                        principalTable: "Experiences",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TripExperiences_Trips_TripId",
                        column: x => x.TripId,
                        principalTable: "Trips",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExperienceCollaborators_ExperienceId",
                table: "ExperienceCollaborators",
                column: "ExperienceId");

            migrationBuilder.CreateIndex(
                name: "IX_ExperienceCollaborators_UserId",
                table: "ExperienceCollaborators",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TripExperiences_ExperienceId",
                table: "TripExperiences",
                column: "ExperienceId");

            migrationBuilder.CreateIndex(
                name: "IX_TripExperiences_TripId",
                table: "TripExperiences",
                column: "TripId");
